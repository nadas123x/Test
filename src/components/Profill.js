...
class Profill extends React.Component {
                            ...
                            <div class="col-md-12 grid-margin">
                                <div class="carrd rounded">
                                    <div class="carrd-bodyy">
                                        <h6 class="carrd-title">Nos diffèrentes catégories:</h6>
                                     <br></br>
                                        <div class="latest-photos">
                                            <div class="row">
                                                <div class="col-mdd-4">
                                                    <figure>
                                                        <NavLink to="/offre/direction">
                                                        <img class="imgg-fluidd" src={require('../assets/img/indus.png')} alt="" />
                                                        <p className='fluid'>  &ensp; &ensp; &ensp; &ensp; &ensp; &ensp; Industrie</p>
                                                        </NavLink>
                                                    </figure>
                                                </div>
                                                <div class="col-mdd-4">
                                                    <figure>
                                                        <img class="imgg-fluidd" src={require('../assets/img/mark.png')} alt="" />
                                                        <p className='fluid'>  &ensp; &ensp; &ensp; &ensp; &ensp;  Marketing</p>
                                                ...
                                                <div class="col-mdd-4">
                                                    <figure>
                                                        <img class="imgg-fluidd" src={require('../assets/img/dig.jpg')} alt="" />
                                                        <p className='fluid'>  &ensp; &ensp; &ensp; &ensp; &ensp; &ensp; Digital</p>

                                                    </figure>
                                                </div>
                                                <div class="col-mdd-4">
                                                    <figure>
                                                        <img class="imgg-fluidd"  src={require('../assets/img/fin.png')} alt="" />
                                                        <p className='fluid'>  &ensp; &ensp; &ensp; &ensp; &ensp; &ensp; Finance</p>

                                                    </figure>
                                                </div>
                                                <div class="col-mdd-4">
                                                    <figure>
                                                        <img class="imgg-fluidd"  src={require('../assets/img/audi.png')} alt="" />
                                                        <p className='fluid'>  &ensp; &ensp; &ensp; &ensp; &ensp; &ensp; Audit</p>
                                                ...
                                                <div class="col-mdd-4">
                                                    <figure>
                                                        <img class="imgg-fluid"  src={require('../assets/img/jur.png')} />
                                                        <p className='fluid'>  &ensp; &ensp; &ensp; &ensp; &ensp; &ensp; Droits
